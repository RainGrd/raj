package com.raj.backend.common;
...
public class CommonController {
     ...
     * @throws IOException
     */
    @PostMapping("/common/uploadDishImage.do")
    @ResponseBody
    public Object uploadDishImage(MultipartFile file) throws IOException {
