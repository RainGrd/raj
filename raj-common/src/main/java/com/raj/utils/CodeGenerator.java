...
//        simpleGenerator();
    ...
    protected static void completeGenerator() {
        ...
        String entityPath = PROJECT_ROOT_PATH + "\\raj-common\\src\\main\\java\\com\\raj\\entity\\backend";
        String mapperPath = PROJECT_ROOT_PATH + "\\raj-dao\\src\\main\\java\\com\\raj\\mapper\\backend";
        String mapperXmlPath = PROJECT_ROOT_PATH + "\\raj-dao\\src\\main\\resources\\com\\raj\\mapper\\backend";
        String servicePath = PROJECT_ROOT_PATH + "\\raj-service\\src\\main\\java\\com\\raj\\service\\backend";
        String serviceImplPath = PROJECT_ROOT_PATH + "\\raj-service\\src\\main\\java\\com\\raj\\service\\backend\\impl";
        String controllerPath = PROJECT_ROOT_PATH + "\\raj-web\\src\\main\\java\\com\\raj\\controller\\backend";
        // 关于以上写法的解释：
