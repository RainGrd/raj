...
public class CodeGenerator {
     ...
     * 数据库连接字符
     */
    private static final String URL = "jdbc:mysql://localhost:3306/reggie?useSSL=false&characterEncoding=utf8&allowPublicKeyRetrieval=true";

    /**
     * 示例：private static final String PARENT_PACKAGE_NAME = "com.example.mybatisplusdemo";
     */
    private static final String PARENT_PACKAGE_NAME = "com.raj.backend";
     ...
     * 数据库密码
     */
    private static final String PASSWORD = "drg1224605";
    /**
     * 项目根路径
     */
...
//        simpleGenerator();
    ...
    protected static void simpleGenerator() {
        ...
        // XML文件的路径
        String mapperXmlPath = PROJECT_ROOT_PATH + "/src/main/resources/com/raj/backend/mapper";
        ...
        FastAutoGenerator.create(URL, USERNAME, PASSWORD)
                ...
                .strategyConfig((scanner, builder) -> builder.addInclude(getTables(scanner.apply("请输入表名，多个英文逗号分隔？生成所有表，请输入[all]：")))
                        ...
                        //乐观锁字段名(数据库)
                        .versionColumnName("versionId")
                        //乐观锁属性名(实体)
                        .versionPropertyName("versionId")
    ...
    protected static void completeGenerator() {
        ...
        String entityPath = PROJECT_ROOT_PATH + "\\raj-common\\src\\main\\java\\com\\raj\\backend\\entity";
        String mapperPath = PROJECT_ROOT_PATH + "\\raj-dao\\src\\main\\java\\com\\raj\\backend\\mapper";
        String mapperXmlPath = PROJECT_ROOT_PATH + "\\raj-dao\\src\\main\\resources\\com\\raj\\backend\\mapper";
        String servicePath = PROJECT_ROOT_PATH + "\\raj-service\\src\\main\\java\\com\\raj\\backend\\service";
        String serviceImplPath = PROJECT_ROOT_PATH + "\\raj-service\\src\\main\\java\\com\\raj\\backend\\service\\impl";
        String controllerPath = PROJECT_ROOT_PATH + "\\raj-web\\src\\main\\java\\com\\raj\\backend\\food\\controller";
        // 关于以上写法的解释：
...
//                                .enableKotlin()
                ...
                .strategyConfig((scanner, builder) -> builder.addInclude(getTables(scanner.apply("请输入表名，多个英文逗号分隔？生成所有表，请输入[all]：")))
                        ...
                        // .formatServiceFileName("%sService")
                        // 格式化 service 实现类文件名称
                        // 如果不设置，如表[sys_user]，默认的是[SysUserServiceImpl]。 写成下面这种形式后，将变成[]。
                        // .formatServiceImplFileName("%sServiceImpl")
